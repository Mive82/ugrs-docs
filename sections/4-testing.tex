...
\begin{figure}[H]
    ...
    \caption{\textit{Prikaz ekrana tijekom testiranja - Multimedija - Uređaj za pohranu podataka}}
    \label{fig:car_multimedia_external_storage}
\end{figure}

Na slikama \ref{fig:car_multimedia_radio} i \ref{fig:radio} je prikazan test prikaza aktivne radio stanice (ako je radio upaljen) iz kojih se može vidjeti kako i ta funkcionalnost ima predviđeno ponašanje.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/3-radiooff.png}
    \caption{\textit{Prikaz ekrana tijekom testiranja - Multimedija - Radio}}
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{\textit{Infotainment sustav smješten u autu}}
        \label{fig:radio}
    \end{center}
\end{figure}