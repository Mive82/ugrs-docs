...
% ESP32
\paragraph{ESP32 - WROOM - C6} glavni mikroupravljač sustava. Komunicira s računalom automobila, obrađuje zaprimljene informacije te ih prosljeđuje RPi mikroupravljaču.
% RPi
...
% Level shifteri
\paragraph{NTS0104GU12\_115}je integrirani strujni krug koji prevodi TTL signale u diferencijalni par i obrnuto.
% 5V voltage reg
...
% 3v3 voltage reg
\paragraph{NCP691MN33T2G} je integrirani strujni krug koji služi kao regulator napona za 3.3 V.
\paragraph{ESP-IDF programski paket}razvijen od Espressif-a se koristi kako je prilagođen za ESP mikroupravljače.
...
U svrhe programiranja je kreirano poseblno sučelje koje koristi tranzistore za programiranje koji su prethodno spomenuti kako bi odabrali način rada mikroupravljača kao i UART serijski protokol za sam prijenos programskog koda. Shema sučelja je prikazana na slici \ref{fig:programming_header}.
\begin{figure}[H]
    \centering
