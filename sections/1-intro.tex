...
\paragraph{Poglavlje 5 – Programska podrška infotainment računala}
Ukratko opisuje softver na Raspberry Pi računalu: korištenu Linux distribuciju, grafičko sučelje (Qt) i glavne funkcionalnosti koje korisnik vidi na ekranu.

\paragraph{Poglavlje 6 – Zaključak i budući planovi}
